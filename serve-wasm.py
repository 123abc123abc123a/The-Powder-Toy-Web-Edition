...
CERT_CN    = 'serve-wasm.py self-signed certificate for powder.js'
CERT_TTL   = 30 * 24 * 60 * 60

print(f'generating index for powder.js')
with open(HTTP_INDEX, 'wt') as f:
	f.write(f'''
<!DOCTYPE html>
<html lang="en">
	<body>
		<p>Remember, this is being served locally, so it will not be able to connect to <a href="https://powdertoy.co.uk">https://powdertoy.co.uk</a>. To enable this, serve the following files there:</p>
		<ul>
			<li>powder.js</li>
			<li>powder.wasm</li>
			<li>powder.wasm.map for debugging purposes</li>
			<li>powder.wasm.dbg for debugging purposes</li>
		</ul>
